...
- Name: e2e/features/all-operators.spec.ts >> All operator addresses >> consignee shows name and country
- Location: tests/e2e/features/all-operators.spec.ts:45:3
    ...
    - main [ref=e43]:
      - generic [ref=e45]:
        - link "Back" [ref=e46] [cursor=pointer]:
          - /url: /addresses
        - paragraph [ref=e47]:
          - generic [ref=e48]: GBN-AG-26-FWQNV3
...
```ts
  ...
  4  | import { PLACE_OF_ORIGIN_NAME, CONSIGNOR_NAME, CONSIGNEE_NAME, IMPORTER_NAME, DESTINATION_NAME, CPH_NUMBER } from '@flows/journey';
  5  | 
