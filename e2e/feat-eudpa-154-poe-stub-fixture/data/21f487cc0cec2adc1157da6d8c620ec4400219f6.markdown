...
- Name: e2e/pages/notification-view-submitted.spec.ts >> Notification view (SUBMITTED) >> shows species rows with ear tag
- Location: tests/e2e/pages/notification-view-submitted.spec.ts:81:3
    ...
    - main [ref=e43]:
      - generic [ref=e45]:
        - link "Back" [ref=e46] [cursor=pointer]:
          - /url: /addresses
        - paragraph [ref=e47]:
          - generic [ref=e48]: GBN-AG-26-JRW13S
